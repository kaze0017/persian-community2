...
export default function BusinessCard({ business }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className='absolute bottom-2 right-2 flex items-center gap-2 bg-[#1b263b] px-2 py-1 rounded shadow'>
        <p className='text-xs text-[#8ecae6] max-w-[100px] truncate'>
          www.yourwebsite.com
        </p>
